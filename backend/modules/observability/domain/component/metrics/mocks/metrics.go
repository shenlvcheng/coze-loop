...
func (m *MockITraceMetrics) EmitSendMetric(isError bool) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "EmitSendMetric", isError)
}

// EmitSendMetric indicates an expected call of EmitSendMetric.
func (mr *MockITraceMetricsMockRecorder) EmitSendMetric(isError any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EmitSendMetric", reflect.TypeOf((*MockITraceMetrics)(nil).EmitSendMetric), isError)
}
